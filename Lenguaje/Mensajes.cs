...
namespace LibreriaV3._1.Modelo
{
    class Mensajes
    {
        ...
        public static String MSG_ERRCAMPO_Titulo = "Es necesario rellenar el título";
        public static String MSG_ERRCAMPOS_VACIO = "Es necesario rellenar todos restantes los campos del formulario";
    }
}
